...
pt: O nome da moeda, atribuído em homenagem à [Ada
Lovelace](https://en.wikipedia.org/wiki/Ada_Lovelace).

en: The name of our currency, named in honor of [Ada
Lovelace](https://en.wikipedia.org/wiki/Ada_Lovelace).

en:## Address
pt:## Endereço

pt:O identificador único de um [nó](#nó). Por favor, leia sobre [Endereços em
Cardano SL](/cardano/addresses/) Para mais detalhes.

en:The unique identifier of a [node](#node). Please read about [Addresses in
Cardano SL](/cardano/addresses/) for more details.

en:## Balance
pt:## Balanço

pt: Por favor, leia sobre [Balanço e participação em Cardano SL](/cardano/balance-and-stake/)
para explicação.

en: Please read about [Balance and Stake in Cardano SL](/cardano/balance-and-stake/)
for explanation.

en:## Block
pt:## Bloco

pt:Uma parte fundamental de um [Registro](#registro). Por favor leia sobre [Blocos em Cardano
SL](/technical/blocks/) para detalhes técnicos.

en:A fundamental part of a [Ledger](#ledger). Please read about [Blocks in Cardano
